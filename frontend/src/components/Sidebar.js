/**
 * Main Sidebar - Shows quick actions, saved tools, and navigation
 */
import React, { useState, useEffect } from 'react';
import { Activity, Wrench, Plus, Play, Trash2, ChevronDown, ChevronRight } from 'lucide-react';
import { SIDEBAR_ACTIONS } from '../lib/constants';
import { API } from '../lib/api';
import axios from 'axios';
import { toast } from 'sonner';

export const Sidebar = ({ erpStatus, onSetInput, onAnalytics, onToolRun, onCreateTool }) => {
  ...
  return (
    <aside className="hidden md:flex flex-col border-r border-border bg-muted/10 w-64">
      <div className="p-6 border-b border-border">
        ...
        <p className="text-sm text-muted-foreground mt-1">AI ERP Orchestration</p>
      </div>
